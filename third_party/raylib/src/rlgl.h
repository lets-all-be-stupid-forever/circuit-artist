...
// Multiple Render Targets (MRT) functions
RLAPI void rlSetupMRT(unsigned int fboId, unsigned int textureId, int totalTargets);
RLAPI void rlResetMRT(unsigned int fboId);
RLAPI void rlAttachTextureToFBO(unsigned int fboId, unsigned int textureId, int attachmentIndex);
RLAPI void rlEnableMultipleRenderTargets(int count);
...
// Multiple Render Targets (MRT) implementation
void rlAttachTextureToFBO(unsigned int fboId, unsigned int textureId, int attachmentIndex)
{
    glBindFramebuffer(GL_FRAMEBUFFER, fboId);
...
void rlEnableMultipleRenderTargets(int count)
{
...
void rlSetupMRT(unsigned int fboId, unsigned int textureId, int totalTargets)
{
    glBindFramebuffer(GL_FRAMEBUFFER, fboId);
    glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT1, GL_TEXTURE_2D, textureId, 0);

    GLenum drawBuffers[] = {GL_COLOR_ATTACHMENT0, GL_COLOR_ATTACHMENT1};
    glDrawBuffers(totalTargets, drawBuffers);

    glBindFramebuffer(GL_FRAMEBUFFER, 0);
}

void rlResetMRT(unsigned int fboId)
{
glBindFramebuffer(GL_FRAMEBUFFER, fboId);
glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT1, GL_TEXTURE_2D, 0, 0);  // detach
